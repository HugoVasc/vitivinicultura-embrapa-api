...
async def comercializacao_categoria(categoria: str = "DERIVADOS"):
    """
    ...
    result = SessionLocal().query(
        ...
        WineCategories, ComercializedWineCategoriesWithQuantity.category_id == WineCategories.id
    ).filter(
...
async def comercializacao_subcategoria_filtro(subcategoria: str = "Tinto"):
    """
