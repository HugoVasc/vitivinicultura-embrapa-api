...
def main():
    ...
    Item2 = { 
        ...
        'arquivoCSV' : '../data/ExpEspumantes.csv'
    }
    ...
    for item in arrayItens:
        ...
        for index, row in df.iterrows():
            ...
            for ano in range(1970,2024):
                ...
                conn.execute(f"INSERT INTO exportacao (countries, quantity_kg, value_usdolars, year, goods_id) VALUES ('{country}',{quantity_kg},{value_usdolars},{ano},{goods_id})")
                conn.commit()
